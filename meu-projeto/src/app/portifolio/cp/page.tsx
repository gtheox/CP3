...
export default function Checkpoint() {
    ...
    const chamadaApi = async () => {
        ...
        // Filtra os trabalhos do tipo "Checkpoint"
        const trabalhosCheckpoint = documents.filter((t: TipoTrabalho) => t.tipodotrabalho === "Checkpoint");
        setListaTrabalhos(trabalhosCheckpoint);
    };
    ...
    return (
        <div className="container mx-auto my-8">
            <h2 className="text-2xl font-bold mb-4">Trabalhos - Checkpoints</h2>
