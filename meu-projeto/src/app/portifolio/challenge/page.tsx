...
export default function ChallengeSprints() {
    ...
    const chamadaApi = async () => {
        ...
        // Filtra os trabalhos do tipo "Challenge Sprints"
        const trabalhosChallenge = documents.filter((t: TipoTrabalho) => t.tipodotrabalho === "Challenge Sprints");
        setListaTrabalhos(trabalhosChallenge);
    };
    ...
    return (
        <div className="container mx-auto my-8">
            <h2 className="text-2xl font-bold mb-4">Trabalhos - Challenge Sprints</h2>
